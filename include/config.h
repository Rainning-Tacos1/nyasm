...
#define DO_LEXER_INDENTATION_DBG 1
...
#define DO_MACRO_NOT_EXPANDING_DBG 1
#define DO_MACRO_EXPANSION_DBG 1
#define DO_MACRO_EXPANDED_TOKENS 1
...
#define MAX_MACRO_EXPANSION_TRACE_LIMIT 6
